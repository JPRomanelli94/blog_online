package com.todocode.blog_online.security.config.filter;
...
public class JwtTokenValidator extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (jwtToken!=null){
            ...
            jwtToken = jwtToken.substring(7); //son siete letras mas un espacio
            ...
            //Si todo esta ok, hay que setearlo en el context holder
            //Para eso debo convertirlos a GrantedAuthority
